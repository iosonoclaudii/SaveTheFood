        ...
        <div class="min-h-screen">
            ...
            <footer class="bg-gray-900 text-gray-300 py-6 mt-10">
                <div class="max-w-7xl mx-auto text-center">
                    <!-- Logo e testo del progetto -->
                    <div class="mb-4">
                        <img src="/images/logo1.png" alt="SaveTheFood Logo" class="h-12 w-12 mx-auto rounded-full" />
                        <h3 class="text-xl font-semibold text-yellow-400 mt-2">SaveTheFood</h3>
                    </div>

                    <!-- Testo breve -->
                    <p class="text-sm max-w-lg mx-auto">
                        Join us in reducing food waste and supporting sustainability.
                    </p>
